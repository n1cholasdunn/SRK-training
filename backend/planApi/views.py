...
@api_view(["GET", "DELETE"])
@permission_classes([IsAuthenticated])
def handle_ymca_step_assessments(request, pk):
    if request.method == "GET":
        return get_ymca_step_assessments(request, pk)
    if request.method == "DELETE":
        return delete_ymca_step_assessments(request, pk)
...
@api_view(["GET", "DELETE"])
@permission_classes([IsAuthenticated])
def handle_sit_reach_assessments(request, pk):
    if request.method == "GET":
        return get_sit_reach_assessments(request, pk)
    if request.method == "DELETE":
        return delete_sit_reach_assessments(request, pk)
...
@api_view(["GET", "DELETE"])
@permission_classes([IsAuthenticated])
def handle_pushup_assessments(request, pk):
    if request.method == "GET":
        return get_pushup_assessments(request, pk)
    if request.method == "DELETE":
        return delete_pushup_assessments(request, pk)
...
@api_view(["GET", "DELETE"])
@permission_classes([IsAuthenticated])
def handle_davies_assessments(request, pk):
    if request.method == "GET":
        return get_davies_assessments(request, pk)
    if request.method == "DELETE":
        return delete_davies_assessments(request, pk)
...
@api_view(["GET", "DELETE"])
@permission_classes([IsAuthenticated])
def handle_core_assessments(request, pk):
    if request.method == "GET":
        return get_core_assessments(request, pk)
    if request.method == "DELETE":
        return delete_core_assessments(request, pk)
...
@api_view(["GET", "DELETE"])
@permission_classes([IsAuthenticated])
def handle_shark_skills_assessments(request, pk):
    if request.method == "GET":
        return get_shark_skills_assessments(request, pk)
    if request.method == "DELETE":
        return delete_shark_skills_assessments(request, pk)
