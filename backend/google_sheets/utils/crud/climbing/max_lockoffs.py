from google_sheets.utils.getters.get_climbing_assessments import get_max_lockoff
...
from common.models.climbing_models import MaxLockoffAssessments, MaxLockoffTest
